...
do
	local RATCHET = {
		{ pattern = "global function [%w_]+%(%.%.%.: any%)", max = 106, label = "untyped global function doors" },
		{ pattern = "global [%w_]+: function%(%.%.%.: any%)", max = 263, label = "ambient (...: any) doors" },
		{ pattern = " as any",                          max = 141, label = "as any" },
