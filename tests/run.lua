...
run_file("tests/gamestate_checks.lua")
run_file("tests/camera_follow_checks.lua")
run_file("tests/hump_timer_checks.lua")
run_file("tests/hump_no_wrapper_checks.lua")
run_file("tests/sti_gone_checks.lua")
run_file("tests/slab_gone_checks.lua")
run_file("tests/monolith_split_checks.lua")
run_file("tests/flux_checks.lua")
run_file("tests/audio_checks.lua")
run_file("tests/input_checks.lua")
...
run_file("tests/bump_hooks_checks.lua")
run_file("tests/spawn_checks.lua")
run_file("tests/levelio_checks.lua")
run_file("tests/endless_gen_checks.lua")
run_file("tests/enemymoves_checks.lua")
run_file("tests/enginefault_checks.lua")
run_file("tests/vglc_import_checks.lua")
run_file("tests/tileset_props_checks.lua")
run_file("tests/mapsdk_checks.lua")
run_file("tests/cavestory_format_checks.lua")
run_file("tests/opensyobon_format_checks.lua")
run_file("tests/mappack_convert_checks.lua")
run_file("tests/mappack_qa/run.lua")
run_file("tests/editor_checks.lua")
run_file("tests/editor_palette_checks.lua")
run_file("tests/autotile_checks.lua")
run_file("tests/menu_checks.lua")
run_file("tests/font_charset_checks.lua")
run_file("tests/metroid_checks.lua")
