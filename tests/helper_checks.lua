...
dofile(root .. "/tilekey.lua")
dofile(root .. "/zones.lua")
dofile(root .. "/bounceutil.lua")
dofile(root .. "/globstate.lua")
dofile(root .. "/tableutil.lua")
dofile(root .. "/listutil.lua")
dofile(root .. "/mathutil.lua")
dofile(root .. "/stringutil.lua")
dofile(root .. "/updateutil.lua")
dofile(root .. "/physicslate.lua")
dofile(root .. "/physicsconvert.lua")
dofile(root .. "/physicsdir.lua")
dofile(root .. "/physicsemance.lua")
dofile(root .. "/maputil.lua")
dofile(root .. "/playerutil.lua")
dofile(root .. "/hatutil.lua")
dofile(root .. "/physicshandlegroup.lua")
dofile(root .. "/portalutil.lua")
dofile(root .. "/scrollutil.lua")
dofile(root .. "/enemyutil.lua")
dofile(root .. "/userectutil.lua")
