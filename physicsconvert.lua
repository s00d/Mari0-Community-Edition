...
-- Uses math.mod (aliased to math.fmod in love.load) and portalrotationalignmentspeed for unrotate.

local atan2 = math.atan2 or math.atan -- LuaJIT/5.1: atan2; Lua 5.3+: atan(y, x)
